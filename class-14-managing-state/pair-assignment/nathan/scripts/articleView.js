(function(module) {
  ...
  // This method populates the filter options and makes an option for each author
  ...
  // COMMENT: What does this method do?  What is it's execution path?
  // This method runs the function when the select button changes, the execution path is created dynamically
  ...
  articleView.index = function(articles) {
    ...
    // COMMENT: What does this method do?  What is it's execution path?
    // Calls the previously declared handleFilters function
